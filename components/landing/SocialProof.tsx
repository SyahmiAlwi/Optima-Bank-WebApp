			...
			<div className="grid lg:grid-cols-2 gap-12 items-center w-full">
				...
				>
					...
					<div className="relative z-10 p-6">
						...
						<blockquote className="text-neutral-200 text-lg leading-relaxed mb-4">&ldquo;Optima Bank has transformed how I manage my finances. The app is intuitive and incredibly fast!&rdquo;</blockquote>
				...
				>
					...
					<div className="relative z-10 p-6">
						...
						<blockquote className="text-neutral-200 text-lg leading-relaxed mb-4">&ldquo;The security features give me peace of mind. Best banking app I&rsquo;ve ever used!&rdquo;</blockquote>
						<figcaption className="flex items-center gap-3">
